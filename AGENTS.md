...
- Never return raw internal errors, env var names, stack traces, or config details in HTTP responses. Log the full error server-side and return a safe user-facing message instead.
